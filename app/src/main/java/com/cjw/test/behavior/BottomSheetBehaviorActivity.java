...
import com.cjw.test.behavior.adapter.ListRecyclerAdapter;
...
public class BottomSheetBehaviorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_behavior_bottomsheet);
    ...
    private void createBottomSheetDialog() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_behavior_bottomsheet, null, false);
        ...
        bottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                if (newState == BottomSheetBehavior.STATE_HIDDEN) {
                    ...
                    // 监听到用户滑动关闭，设置为半个打开状态，不然再次调用dialog.show()的时候Dialog没法再此打开状态为HIDE的dialog了。
